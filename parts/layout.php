...
<head>
    <meta charset="utf-8">
    <title>Univers Soft Consulting :: Site Officiel</title>
...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <?php require $_c=='index'?'slide.php':'title.php' ?>
    </div>
    <!-- Header End -->
     <?= $_content ?>
    ...
    <!-- Back to Top -->
    <a href="#" class="btn btn-outline-primary border-2 btn-lg-square back-to-top"><i class="fa fa-arrow-up"></i></a>
